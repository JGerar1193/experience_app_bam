...
class _$CartItemImpl extends _CartItem {
  ...
  @override
  String toString() {
    return 'CartItem(product: $product, quantity: $quantity, selectedSize: $selectedSize, selectedColor: $selectedColor)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, product, quantity, selectedSize, selectedColor);
